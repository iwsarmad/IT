                ...
                <div class="col-lg-12">
                    <form class="card" method="post" action="{{url('/StoresClient')}}">
                        ...
                        <div class="card-header">
                            <h3 class="card-title">Select Your Database </h3>
                        </div>
                        <div class="card-body">
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        <label class="form-label">Data Base One</label>
                                        <input type="radio"  name="ClientEmail" >
                                    </div>
                                </div>

                                <div class="col-lg-12">
                                    <div class="form-group">
                                        <label class="form-label">Data Base Two</label>
                                        <input type="radio"  name="ClientEmail" >
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        <label class="form-label">Data Base Three</label>
                                        <input type="radio"  name="ClientEmail">
                                    </div>
                                </div>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="activity mt-3">
                                <img src="assets/images/faces/male/7.jpg" alt="" class="img-activity cover-image">
                                ...
                                <img src="assets/images/faces/female/4.jpg" alt="" class="img-activity">
                                <div class="time-activity">
                                    <div class="item-activity">
                                ...
                                <img src="assets/images/faces/male/8.jpg" alt="" class="img-activity">
                                <div class="time-activity">
                                    <div class="item-activity">
