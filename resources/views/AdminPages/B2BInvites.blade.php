    ...
    <div class="app-content  my-3 my-md-5">
        <div class="side-app">
            <div class="page-header">
                <h4 class="page-title">B2B Invites</h4>
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="#">Customer</a></li>
                    <li class="breadcrumb-item active" aria-current="page">B2B Invites</li>
                </ol>
            </div>
                            ...
                            <table class="table caption-top">
                                ...
                                @foreach($CurrentClients as $CurrentClient)
                                    <tr>
                                        ...
                                        <td>{{$CurrentClient->EMAIL1}}</td>
                                        <td>{{$CurrentClient->COGNOME_NOME}}</td>
