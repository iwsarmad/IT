                        ...
                        <div class="row">
                            ...
                            <table class="table caption-top">
                                ...
                                <tr>
                                    ...
                                    <th scope="col">NUM_REG</th>
                                    <th scope="col">DAT_SCAD</th>
                                    <th scope="col">IMPORTO</th>
                                    <th scope="col">DES_STATO</th>
                                ...
                                <tbody>
                                @foreach($ExpirationDate as $Product)


                                    <tr>
                                        <td>{{$Product->COD_CLIFOR}}</td>
                                        <td>{{$Product->TIPO_CLIFOR}}</td>
                                        <td>{{$Product->NUM_DOC}}</td>
                                        <td>{{$Product->DATA_DOC}}</td>
                                        <td>{{$Product->NUM_REG}}</td>
                                        <td>{{$Product->DAT_SCAD}}</td>
                                        <td>{{$Product->IMPORTO}}</td>
                                        <td>{{$Product->DES_STATO}}</td>
                                    </tr>
                                @endforeach
                                </tbody>
                            </table>
